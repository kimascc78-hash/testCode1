...
class AGCWidget(QGroupBox):
    ...
    def init_ui(self):
        ...
        self.ref_setup_time_spin = QSpinBox()
        ...
        agc_time_layout = QVBoxLayout(agc_time_group)
        
        self.agc_setup_time_spins = []
        for i in range(4):
            time_layout = QHBoxLayout()
            time_layout.addWidget(QLabel(f"Time {i}:"))
        ...
        for i, label in enumerate(gain_rate_labels):
            ...
            rate_layout.addWidget(QLabel(label))
            ...
            rate_layout.addWidget(spin)
            rate_layout.addStretch()
            gain_rate_layout.addLayout(rate_layout)
        ...
        self.init_power_gain_spin = QDoubleSpinBox()
