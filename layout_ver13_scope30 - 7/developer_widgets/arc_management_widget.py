...
from PyQt5.QtWidgets import (
    ...
    QRadioButton, QSpinBox, QDoubleSpinBox, QButtonGroup, QMessageBox
)
...
class ArcManagementWidget(QGroupBox):
    ...
    def init_ui(self):
        ...
        self.reflected_threshold_spin = QDoubleSpinBox()
        ...
        threshold_layout.addWidget(self.reflected_threshold_spin)
        threshold_layout.addStretch()
        reflected_layout.addLayout(threshold_layout)
        ...
        suppression_layout.addWidget(QLabel("Suppression Time:"))
        
        self.suppression_time_spin = QSpinBox()
        ...
        suppression_layout.addWidget(self.suppression_time_spin)
        suppression_layout.addWidget(QLabel("(0=Disabled, 5~511)"))
        suppression_layout.addStretch()
        timing_layout.addLayout(suppression_layout)
        
        # Initial Delay Time
        initial_delay_layout = QHBoxLayout()
        initial_delay_layout.addWidget(QLabel("Initial Delay:"))
        ...
        initial_delay_layout.addWidget(self.initial_delay_spin)
        initial_delay_layout.addWidget(QLabel("(0~10,000)"))
        initial_delay_layout.addStretch()
        timing_layout.addLayout(initial_delay_layout)
        
        # Setpoint Delay Time
        setpoint_delay_layout = QHBoxLayout()
        setpoint_delay_layout.addWidget(QLabel("Setpoint Delay:"))
        
        self.setpoint_delay_spin = QSpinBox()
        self.setpoint_delay_spin.setRange(0, 245)
        self.setpoint_delay_spin.setValue(0)
        self.setpoint_delay_spin.setSuffix(" ms")
        
        setpoint_delay_layout.addWidget(self.setpoint_delay_spin)
        setpoint_delay_layout.addWidget(QLabel("(0~245)"))
        setpoint_delay_layout.addStretch()
        timing_layout.addLayout(setpoint_delay_layout)
        ...
        attempts_layout.addWidget(QLabel("(0=Unlimited, 1~250)"))
        attempts_layout.addStretch()
        self.main_layout.addLayout(attempts_layout)
        ...
        load_button = QPushButton("Load from Device")
