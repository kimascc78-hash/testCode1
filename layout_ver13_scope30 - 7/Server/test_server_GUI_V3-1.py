        ...
        while self.running:
            try:
                ...
                # ==========================================
                    ...
                    # 명시적으로 처리되지 않은 명령어에 대한 기본 응답 (성공: 0x00)
                    self.log_message(f"Unhandled command: CMD=0x{cmd:02X}, SUBCMD=0x{subcmd:02X} from {addr}")
